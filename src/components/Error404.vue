<template>
  <div class="error-page window-height window-width bg-light column items-center">
    <div class="error-code bg-primary flex items-center justify-center text-warning">
      404
    </div>
    <div>
      <div class="error-card card bg-white column items-center justify-center">
        ...
        <p class="text-center group">
          <button v-if="canGoBack" class="grey glossy push big text-warning" @click="goBack">
            <i class="on-left">keyboard_arrow_left</i>
            Go back
          </button>
          <router-link to="/">
            <button class="ternary text-warning glossy push big">
              Go home
